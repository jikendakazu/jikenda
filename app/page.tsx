...
export default function Page() {
  ...
  async function signUp() {
    ...
    setMsg(error ? `SignUp error: ${error.message}` : "サインアップ完了。確認メールをチェックしてください。");
  }
            ...
            <div style={{display:"grid", gap:8, maxWidth:640}}>
              <label>
                ...
                <select value={category} onChange={e=>setCategory(e.target.value)}>
                  <option>労働</option><option>離婚</option><option>借金</option>
                  <option>交通事故</option><option>その他</option>
                </select>
              </label>
